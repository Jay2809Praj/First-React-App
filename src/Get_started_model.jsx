...
const Get_started_model = ({ ShowObject, showImage }) => {
  ...
  const handleInput = (event) => {
    ...
    } else setUserRegistretion({ ...userRegistretion, [name]: value });
  };
          ...
          <ModalBody>
            <Form>
              ...
              <FormGroup row>
                ...
                <Col sm={10}>
                  <input name="file" type="file" onChange={handleInput} />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label for="exampleFile" sm={2}>
                ...
                <Col sm={10}>
                  <input name="pdf" type="file" onChange={handleInput} />
                </Col>
              </FormGroup>
              ...
              <FormGroup check row>
                ...
                >
                  <Button onClick={getObject}>Submit</Button>
                </Col>
              </FormGroup>
            </Form>
          </ModalBody>
